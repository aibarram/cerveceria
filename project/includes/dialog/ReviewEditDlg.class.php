...
require(__DIALOG_GEN__ . '/ReviewEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * ReviewEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class ReviewEditDlg extends ReviewEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the ReviewEditPanel panel that is
