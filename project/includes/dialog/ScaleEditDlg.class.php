...
require(__DIALOG_GEN__ . '/ScaleEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * ScaleEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class ScaleEditDlg extends ScaleEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the ScaleEditPanel panel that is
