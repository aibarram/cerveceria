...
require(__DIALOG_GEN__ . '/BeerEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * BeerEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class BeerEditDlg extends BeerEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the BeerEditPanel panel that is
