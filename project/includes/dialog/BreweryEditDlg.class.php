...
require(__DIALOG_GEN__ . '/BreweryEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * BreweryEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class BreweryEditDlg extends BreweryEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the BreweryEditPanel panel that is
