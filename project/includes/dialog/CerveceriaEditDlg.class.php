...
require(__DIALOG_GEN__ . '/CerveceriaEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * CerveceriaEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class CerveceriaEditDlg extends CerveceriaEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the CerveceriaEditPanel panel that is
