...
require(__DIALOG_GEN__ . '/TypeEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * TypeEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class TypeEditDlg extends TypeEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the TypeEditPanel panel that is
