...
require(__DIALOG_GEN__ . '/IngredientEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * IngredientEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class IngredientEditDlg extends IngredientEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the IngredientEditPanel panel that is
