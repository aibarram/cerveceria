...
require(__DIALOG_GEN__ . '/QualificationEditDlgGen.class.php');

/**
 * This is the customizable subclass for the edit dialog. This dialog is just a shell for the
 * QualificationEditPanel class, and so you will not likely need to do major customizations here.
 ...
 *
 */
class QualificationEditDlg extends QualificationEditDlgGen {
	...
	public function __construct($objParent = null, $strControlId = null) {
		...
		/**
		 * Setting AutoRenderChildren will automatically draw the QualificationEditPanel panel that is
