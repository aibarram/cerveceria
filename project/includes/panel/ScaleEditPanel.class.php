<?php
require(__PANEL_GEN__ . '/ScaleEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Scale class. This is where you should create your customizations to the edit
 * panel that edits a scale record.
 *
 ...
 *
 */
class ScaleEditPanel extends ScaleEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/ScaleEditPanel.tpl.php';
	}
}
