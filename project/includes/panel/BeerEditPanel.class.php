<?php
require(__PANEL_GEN__ . '/BeerEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Beer class. This is where you should create your customizations to the edit
 * panel that edits a beer record.
 *
 ...
 *
 */
class BeerEditPanel extends BeerEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/BeerEditPanel.tpl.php';
	}
}
