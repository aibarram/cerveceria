<?php
require(__PANEL_GEN__ . '/ReviewEditPanelGen.class.php');

/**
 * This is the customizable subclass for the edit panel functionality
 * of the Review class. This is where you should create your customizations to the edit
 * panel that edits a review record.
 *
 ...
 *
 */
class ReviewEditPanel extends ReviewEditPanelGen {
	public function __construct($objParent, $strControlId = null) {
		...
		//$this->Template = __PANEL_GEN__ . '/ReviewEditPanel.tpl.php';
	}
}
