...
require(__PANEL__ . '/IngredientEditPanel.class.php');
 ...
 * IngredientConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Ingredient columns.
 *
...
class IngredientEditForm extends QForm {
	...
	/** @var IngredientEditPanel  */
	protected $pnlIngredient;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Ingredient');
        $this->strObjectNamePlural = QApplication::Translate('Ingredients');

        $this->pnlIngredient = new IngredientEditPanel($this);
		$intId = QApplication::QueryString('intId');
	    $this->pnlIngredient->Load($intId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Ingredient'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlIngredient->mctIngredient->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlIngredient->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlIngredient->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/ingredient_list.php',
