<?php
	...
	require(__PANEL__ . '/TypeListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Type class, and is a starting point for the form object.
	 *
	 ...
	 */
	class TypeListForm extends QForm {
        /** @var NavPanel */
		protected $pnlNav;
        /** @var TypeListPanel */
		protected $pnlTypeList;
        /** @var string */
		...
		protected function Form_Create() {
			...
			$this->pnlTypeList = new TypeListPanel($this);
		}
	...
	// type_list.tpl.php as the included HTML template file
	TypeListForm::Run('TypeListForm');