...
require(__PANEL__ . '/CerveceriaEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Cerveceria class.  It uses the code-generated
 * CerveceriaConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Cerveceria columns.
 *
 ...
 * @subpackage Drafts
 */
class CerveceriaEditForm extends QForm {

	/** @var CerveceriaEditPanel  */
	protected $pnlCerveceria;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->pnlCerveceria = new CerveceriaEditPanel($this);
		$intId = QApplication::QueryString('intId');
	    $this->pnlCerveceria->Load($intId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Cerveceria'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlCerveceria->mctCerveceria->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlCerveceria->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlCerveceria->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/cerveceria_list.php',
...
// cerveceria_edit.tpl.php as the included HTML template file
CerveceriaEditForm::Run('CerveceriaEditForm');
