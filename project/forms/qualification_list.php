<?php
	...
	require(__PANEL__ . '/QualificationListPanel.class.php');

	/**
	 * This is a draft QForm object to do the List All functionality
	 * of the Qualification class, and is a starting point for the form object.
	 *
	...
	class QualificationListForm extends QForm {
        /** @var NavPanel */
		protected $pnlNav;
        /** @var QualificationListPanel */
		protected $pnlQualificationList;
        /** @var string */
		...
		protected function Form_Create() {
			...
			$this->pnlQualificationList = new QualificationListPanel($this);
		}
