...
require(__PANEL__ . '/QualificationEditPanel.class.php');
 ...
 * QualificationConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Qualification columns.
 *
 ...
 * @subpackage Drafts
 */
class QualificationEditForm extends QForm {
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Qualification');
        $this->strObjectNamePlural = QApplication::Translate('Qualifications');
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Qualification'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlQualification->mctQualification->EditMode;
	}
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/qualification_list.php',
...
// qualification_edit.tpl.php as the included HTML template file
QualificationEditForm::Run('QualificationEditForm');
