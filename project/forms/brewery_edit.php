...
require(__PANEL__ . '/BreweryEditPanel.class.php');

/**
 * This is a draft QForm object to do Create, Edit, and Delete functionality
 * of the Brewery class.  It uses the code-generated
 * BreweryConnector class, which has methods to help with
 * easily creating/defining controls to modify the fields of Brewery columns.
 *
 ...
 * @subpackage Drafts
 */
class BreweryEditForm extends QForm {

	/** @var BreweryEditPanel  */
	protected $pnlBrewery;
...
//	protected function Form_Load() {}
	...
	protected function Form_Create() {
        ...
        $this->strObjectName = QApplication::Translate('Brewery');
        $this->strObjectNamePlural = QApplication::Translate('Breweries');

        $this->pnlBrewery = new BreweryEditPanel($this);
		$intId = QApplication::QueryString('intId');
	    $this->pnlBrewery->Load($intId);
		$this->CreateButtons();
	}
	...
	protected function CreateButtons() {
		...
		$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'), QApplication::Translate('Brewery'))));
		$this->btnDelete->AddAction(new QClickEvent(), new QAjaxAction('btnDelete_Click'));
		$this->btnDelete->Visible = $this->pnlBrewery->mctBrewery->EditMode;
	}
    ...
    */
    protected function dlgOptimisticLocking_ButtonEvent($strFormId, $strControlId, $btn) {
        if ($btn == "Overwrite") {
            $this->pnlBrewery->Save(true);
            $this->GetControl($strControlId)->Close();
            $this->RedirectToListPage();
        } else { // Refresh
            $this->GetControl($strControlId)->Close();
            $this->pnlBrewery->Refresh(true);
        }
    }
    ...
    */
	protected function RedirectToListPage() {
		QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORMS__ . '/brewery_list.php',
...
// brewery_edit.tpl.php as the included HTML template file
BreweryEditForm::Run('BreweryEditForm');
