<?php
	/**
	 * This is a draft template file for the QualificationListPanel.
     ...
     * Template property of the QualificationListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgQualifications); ?>
<?= _r($this->pnlButtons); ?>
