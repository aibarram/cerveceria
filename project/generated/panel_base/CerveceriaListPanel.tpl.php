<?php
	/**
	 * This is a draft template file for the CerveceriaListPanel.
     ...
     * Template property of the CerveceriaListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgCervecerias); ?>
<?= _r($this->pnlButtons); ?>
