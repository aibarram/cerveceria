...
/**
 * This is the base list class for the  Brewery class.
 *
 ...
 */
abstract class BreweryListPanelGen extends QPanel {
	/** @var QPanel **/
	protected $pnlFilter;
	...
	public function __construct($objParent, $strControlId = null) {
		...
		$this->dtgBreweries_Create();
		$this->dtgBreweries->SetDataBinder('BindData', $this);
	...
	**/
	protected function dtgBreweries_Create() {
		$this->dtgBreweries = new BreweryList($this);
		$this->dtgBreweries_CreateColumns();
		$this->dtgBreweries_MakeEditable();
		$this->dtgBreweries->RowParamsCallback = [$this, "dtgBreweries_GetRowParams"];
			$this->dtgBreweries->LinkedNode = QQN::Brewery();
	}
	...
	**/
	protected function dtgBreweries_CreateColumns() {
		$this->dtgBreweries->CreateColumns();
	}

	protected function dtgBreweries_MakeEditable() {
		$this->dtgBreweries->AddAction(new QCellClickEvent(0, null, null, true), new QAjaxControlAction($this, 'dtgBreweries_CellClick', null, null, QCellClickEvent::RowValue));
		$this->dtgBreweries->AddCssClass('clickable-rows');
	}

	protected function dtgBreweries_CellClick($strFormId, $strControlId, $strParameter) {
		if ($strParameter) {
			$this->EditItem($strParameter);
		}
	}
	public function dtgBreweries_GetRowParams($objRowObject, $intRowIndex) {
	...
	public function BindData() {
		...
		$this->dtgBreweries->BindData($objCondition);
	}
	...
	protected function GetCondition() {
		...
		if (is_null($strSearchValue) || $strSearchValue === '') {
			...
			return QQ::OrCondition(
				QQ::Equal(QQN::Brewery()->Id, $strSearchValue),
            QQ::Like(QQN::Brewery()->Name, "%" . $strSearchValue . "%"),
            QQ::Like(QQN::Brewery()->Description, "%" . $strSearchValue . "%")
			);
		}
	...
	protected function EditItem ($strKey = null) {
		...
		$strEditPageUrl = __VIRTUAL_DIRECTORY__ . __FORMS__ . '/brewery_edit.php' . $strQuery;
