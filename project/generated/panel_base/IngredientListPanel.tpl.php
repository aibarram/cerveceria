<?php
	/**
	 * This is a draft template file for the IngredientListPanel.
     ...
     * Template property of the IngredientListPanel to point to the new location.
	 **/
?>

<?= _r($this->pnlFilter); ?>
<?= _r($this->dtgIngredients); ?>
<?= _r($this->pnlButtons); ?>
