...
include (__PANEL__ . '/ReviewEditPanel.class.php');

/**
 * This is the ReviewEditDlgGen class.  It uses the code-generated
 * ReviewEditPanel class, which has all the controls for editing
 ...
 * @subpackage Dialogs
 */
class ReviewEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Review')),
