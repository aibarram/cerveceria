...
include (__PANEL__ . '/ScaleEditPanel.class.php');

/**
 * This is the ScaleEditDlgGen class.  It uses the code-generated
 * ScaleEditPanel class, which has all the controls for editing
 * a record in the scale table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class ScaleEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Scale')),
