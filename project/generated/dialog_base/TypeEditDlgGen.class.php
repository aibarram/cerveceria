...
include (__PANEL__ . '/TypeEditPanel.class.php');

/**
 * This is the TypeEditDlgGen class.  It uses the code-generated
 * TypeEditPanel class, which has all the controls for editing
 * a record in the type table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class TypeEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Type')),
