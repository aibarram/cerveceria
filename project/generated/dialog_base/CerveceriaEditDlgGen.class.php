...
include (__PANEL__ . '/CerveceriaEditPanel.class.php');

/**
 * This is the CerveceriaEditDlgGen class.  It uses the code-generated
 * CerveceriaEditPanel class, which has all the controls for editing
 * a record in the cerveceria table.
 *
 *
 * @package My QCubed Application
 * @subpackage Dialogs
 */
class CerveceriaEditDlgGen extends QDialog {
	...
	protected function CreateButtons() {
		...
		$this->AddButton(QApplication::Translate('Delete'), 'delete', false, false,
			sprintf(QApplication::Translate('Are you SURE you want to DELETE this %s?'),  QApplication::Translate('Cerveceria')),
