 ...
 * subclasses a Cerveceria class and can be used to display
 * a collection of Cerveceria objects.
 *
...
class CerveceriaListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Cerveceria()->Id);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Cerveceria()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Cerveceria()->Description);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Cerveceria()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Cerveceria::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Cerveceria::QueryArray($objCondition, $objClauses);
	}
