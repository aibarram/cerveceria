 ...
 * subclasses a Review class and can be used to display
...
class ReviewListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Review()->Id);
		$this->colBeer = $this->CreateNodeColumn("Beer", QQN::Review()->Beer);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Review::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Review::QueryArray($objCondition, $objClauses);
	}
