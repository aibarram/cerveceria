 ...
 * subclasses a Ingredient class and can be used to display
 * a collection of Ingredient objects.
 *
...
class IngredientListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Ingredient()->Id);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Ingredient()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Ingredient()->Description);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Ingredient()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Ingredient::QueryCount($objCondition, $objClauses);
		}
