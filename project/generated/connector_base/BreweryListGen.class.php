 ...
 * subclasses a Brewery class and can be used to display
 * a collection of Brewery objects.
 *
...
class BreweryListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Brewery()->Id);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Brewery()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Brewery()->Description);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Brewery()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Brewery::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Brewery::QueryArray($objCondition, $objClauses);
	}
