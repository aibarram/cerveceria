 ...
 * subclasses a Scale class and can be used to display
...
class ScaleListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Scale()->Id);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Scale()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Scale()->Description);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Scale()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Scale::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Scale::QueryArray($objCondition, $objClauses);
	}
