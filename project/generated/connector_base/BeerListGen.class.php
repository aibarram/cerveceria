 ...
 * subclasses a Beer class and can be used to display
 * a collection of Beer objects.
 *
...
class BeerListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Beer()->Id);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Beer()->Description);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Beer()->Name);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Beer()->Active);
		$this->colCervceria = $this->CreateNodeColumn("Cervceria", QQN::Beer()->Cervceria);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Beer::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Beer::QueryArray($objCondition, $objClauses);
	}
