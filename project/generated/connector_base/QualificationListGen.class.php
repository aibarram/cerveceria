 ...
 * subclasses a Qualification class and can be used to display
 * a collection of Qualification objects.
 *
...
class QualificationListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Qualification()->Id);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Qualification()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Qualification()->Description);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Qualification()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Qualification::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Qualification::QueryArray($objCondition, $objClauses);
	}
