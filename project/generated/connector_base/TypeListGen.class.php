 ...
 * subclasses a Type class and can be used to display
...
class TypeListGen extends QDataGrid {
	/**
	...
	public function CreateColumns() {
		$this->colId = $this->CreateNodeColumn("Id", QQN::Type()->Id);
		$this->colName = $this->CreateNodeColumn("Name", QQN::Type()->Name);
		$this->colDescription = $this->CreateNodeColumn("Description", QQN::Type()->Description);
		$this->colActive = $this->CreateNodeColumn("Active", QQN::Type()->Active);
	}
	...
	**/
	public function BindData($objAdditionalCondition = null, $objAdditionalClauses = null) {
		...
		if ($this->Paginator) {
			$this->TotalItemCount = Type::QueryCount($objCondition, $objClauses);
		}
		...
		$this->DataSource = Type::QueryArray($objCondition, $objClauses);
	}
